...
$(document).ready(function(){
	...
	canvas = /*document.getElementById('pixie');*/ $("<canvas id='pixie' width='100%' height='1080' style='position:absolute; top:0; left:0;right:0;margin:auto; z-index:-1;'></canvas>").appendTo('#container').get(0);
...
function Circle() {
	...
	this.draw = function() {
		...
		g.addColorStop(0.0, 'rgba(130,187,22,'+newo+')');
		g.addColorStop(this.stop, 'rgba(130,187,22,'+(newo*.6)+')');
		g.addColorStop(1.0, 'rgba(130,187,22,0)');
		con.fillStyle = g;
		con.fill();
	}
